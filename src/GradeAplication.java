...
public class GradeAplication {
	...
	public static void main(String[] args) {
		...
		int counter = 1, totalScore = 0, mean = 0, femScore = 0, meanFem = 0, malScore = 0, meanMal = 0, finScore = 0,
		...
		System.out.println("Average for Gender: Female=" + meanFem + " Male=" + meanMal);
		System.out.println("Average for Major: Finance=" + meanFin + " Math=" + meanMath + " Physics=" + meanPhy);
		System.out.println("Average by State: Maryland=" + meanMd + " Virginia=" + meanVg + " Pensylvanis=" + meanPa);
		sc.close();
	}
